/*
cron "20 2-22/2 * * *" jd_CheckCK.js, tag:京东CK检测by-ccwav
 */
    ...
    for (let i = 0; i < envs.length; i++) {
        if (envs[i].value) {
            ...
            if ($.error) {
                ...
                if (!$.isLogin) {
                    const content = "如果要继续挂机，请前去登录。\n\n登录网站：https://jd.daodan.show:10086\n请使用手机登陆，而非扫码登陆。\n\nQQ登录机器人：2790973907\n添加好友后发送登录，然后按照提示进行登录。"
                    if (strnowstatus == 0) {
